...
var li_arr = ["Put on this page information about your product",
...
var main__li_arr = ["aboutZone", "pluses", "scrinShots", "reviews", "buy", "contacts"];
//Тельцо - подзаголовки
for (var i = 0; i < 6; i++) {
...
var aboutZone__content = main.querySelector('.aboutZone').querySelector('.content');
...
aboutZone__content_p1.innerText = 'Lorem ipsum dolor sit amet' +
...
aboutZone__content_p2.innerText = 'Pariatur iure ab sunt nesciunt, quibusdam odio iste cumque itaque,' +
...
for (var i = 0; i < 6; i++) {
    ...
    pluspoint.innerText = 'Delectus dolorem vero quae beatae quasi dolor deserunt iste amet atque,' +
...
var scrinShots__content = main.querySelector('.scrinShots').querySelector('.content');
...
for (var i = 0; i < 4; i++) {
    ...
    if (i < 2) {
        scrinSots__p.innerText = 'Pariatur iure ab sunt nesciunt, quibusdam odio iste cumque itaque, ipsa vel' +
        ...
        scrinSots__p.innerText = 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nobis facilis fuga, illo at.' +
...
reviewContainer.className = 'scrinContainer';
...
for (var i = 0; i < 50000; i++) {
    ...
    review__p.innerText = 'Porro officia cumque sint deleniti nemo facere rem vitae odit inventore cum odio,' +
...
var contacts__content = main.querySelector('.contacts').querySelector('.content');
...
var contacts__map = new Map([['skype', 'here_your_login_skype'],
['icq', '279679659'], ['ourMail', 'psdhtmlcss@mail.ru'], ['phone', '80 00 4568 55 55']]);
...
//сами иконки
var contacts__icons_arr = ["twitter", "facebook", "linkedin", "google", "youtube"];
